  ...
  return (
    <section id="hero-section" className="relative" style={{
      ...
      <div className="container max-w-6xl mx-auto px-4 md:px-6 pt-[90px] md:pt-[110px] pb-[80px] md:pb-[80px] flex flex-col md:grid md:grid-cols-5 gap-6 md:gap-14 items-center">
        ...
        <div className="md:col-span-3 space-y-7 order-1">
          ...
          {/* Form on mobile — inserted between headline and subtitle */}
          <div className="md:hidden">
            <div id="demo-form-mobile" className="bg-background rounded-xl px-6 py-7" style={{ boxShadow: "0 2px 8px rgba(0,0,0,0.06)" }}>
              {submitted ?
